...
SWIFT_CLASS("_TtC7souless11AppDelegate")
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified sharedButton;
@property (nonatomic, weak) IBOutlet UIBarButtonItem * _Null_unspecified removeButtom;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imageView;
- (void)viewWillAppear:(BOOL)animated;
- (void)handleSelectProfileImageView;
- (void)viewDidLoad;
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (IBAction)sharedButton_pressed:(id _Nonnull)sender;
- (IBAction)removeButton:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC7souless18HomeViewController")
@interface HomeViewController : UIViewController
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tableView;
- (void)viewDidLoad;
- (IBAction)logOut:(id _Nonnull)sender;
- (IBAction)massageButton:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface HomeViewController (SWIFT_EXTENSION(souless)) <UITableViewDataSource, UITableViewDelegate>
...
SWIFT_CLASS("_TtC7souless8MainView")
...
- (IBAction)likeButton:(id _Nonnull)sender;
- (nonnull instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString * _Nullable)reuseIdentifier OBJC_DESIGNATED_INITIALIZER SWIFT_AVAILABILITY(ios,introduced=3.0);
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC7souless11ProfileView")
...
SWIFT_CLASS("_TtC7souless10SignUpView")
...
- (void)textFieldDidChenge;
- (void)handleSelectProfileImageView;
- (IBAction)dismiss_onClick:(id _Nonnull)sender;
